...
E7G-T v0.11-UC2 is a unified reference candidate integrating three complementary routes:
...
Until promotion under §3.9.9 and §19.9, omission of these fields does not make an ordinary analysis non-conforming under §§16.1–16.3.
...
- the candidate observational-claim module passes the §19.9 promotion test or is revised, retained as informative, or removed;
...
### 19.8 General pilot evaluation question
...
### 19.9 Observational-claim promotion decision
